"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_dynamic-web-vue-components_src_GlobalComponents_ButtonIconLink_Component_vue"],{
...
var render = function render() {
  ...
  return _c(
    ...
    {
      tag: "component",
      attrs: { href: _vm.url, type: "submit", "aria-label": _vm.aria_label },
      on: {
        click: () => {
          this.$emit("on_click")
        },
